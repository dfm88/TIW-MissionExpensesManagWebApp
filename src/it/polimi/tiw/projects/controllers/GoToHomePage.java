...
public class GoToHomePage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String imagepath = getServletContext().getContextPath() + "/immagini/guernica_picasso.jpg";
		System.out.println("aaaaaaaaaa     " +loginpath);
		System.out.println("bbbbbbb     " +imagepath);
